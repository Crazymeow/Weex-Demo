! function(e, t, i) {
	...
	return i.prototype = {
		...
		init: function() {
			var e = this;
			return a++, e.setStyle(), e.addAlertBox(), "mini" == e.type ? e.minEvent() : e.alertEvent(), e
		},
		...
		minEvent: function() {
			var e = this;
			setTimeout(function() {
				navigator.userAgent.match(/iPhone/i) && "undefined" != typeof Zepto ? $(e.alertBox).fadeOut(500, function() {
					e.getEl(t, "body").removeChild(e.alertBox), e.callback && "function" == typeof e.callback && e.callback()
		...
		reset: function(e, i) {
			var a = this;
			e.onclick = function() {
				var e = i && "function" == typeof i && i(this);
				e !== !1 && ("fixed" != a.alertType && a.remove(a.alertBox), a.remove(a.getEl(t, "#alertMask_" + a.uuid)))
			}
		},
		remove: function(e) {
		...
		destroy: function() {
			this.remove(this.alertBox), this.remove(this.getEl(t, "#alertMask_" + this.uuid))
		}
	}, i
}, document);